...
const UserBoxes = () => {
  ...
  return (
    <div className='bg-dark-blue flex items-center flex-col min-h-screen overflow-auto'>
      <p className='text-green-900 px-5 text-xl font-bold py-3 w-full bg-yellow-400'>GIVEAWAY 1</p>
...
{/* slot booked congo start */}
      <p className=' text-white text-lg'>slots 1 - 100</p>
          ...
          {[...Array(20)].map((_, rowIndex) => (
            <ul key={rowIndex} className='flex p-5 gap-5'>
              {[...Array(5)].map((_, colIndex) => {
                const checkboxName = `${rowIndex * 5 + colIndex + 1}`;
                return (
                  <input
