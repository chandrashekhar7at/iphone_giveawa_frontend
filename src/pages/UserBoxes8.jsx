...
const UserBoxes8 = () => {
  ...
  return (
    <div className='bg-dark-blue flex items-center flex-col min-h-screen overflow-auto'>
      <p className='text-green-900 px-5 text-xl font-bold py-3 w-full bg-yellow-400'>GIVEAWAY 8</p>
...
<p className=' text-white text-lg'>slots 702 - 801</p>
          ...
          {[...Array(20)].map((_, rowIndex) => (
            <ul key={rowIndex} className='flex p-5 gap-5'>
              {[...Array(5)].map((_, colIndex) => {
                const checkboxName = `${701 + rowIndex * 5 + colIndex + 1}`;
                return (
                  <input
                    key={701 + rowIndex * 5 + colIndex}
                    type='checkbox'
